...
const SUPPORT_EMAIL = 'admin@freakhouse.dev';
const NOREPLY_EMAIL = 'no-reply@freakhouse.dev';
const DOMAIN = 'localhost';

const MAILER_NAME = 'FreakExchange Mailer';
const START_MESSAGE = 'FreakExchange started!';
const OPENTRADE = "FreakExchange";
